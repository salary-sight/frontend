export const loadingText = [
    ...
    "Someone please fund my startup",
    "When do we get food?",
    "Monkeys wrote this code"
];
...
export const pastPositions = ['Academic researcher', 'Data or business analyst',
...
export const skills = ['Assembly', 'Bash/Shell/PowerShell', 'C', 'C#', 'C++', 'Go', 'HTML/CSS',
    ...
    'Laravel']
export const yearsCode = [...Array(51)].map((_,i) => i).map(String);